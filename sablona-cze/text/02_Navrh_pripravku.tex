...
Přípravek je v~této fázi vývoje napájen prostřednictvím \acs{USB} sběrnice Arduina napětím 5\,\unit{V}. Všechny součástky jsou zatím vsazeny do nepájivého kontaktního pole. Fotografie protoypu jsou přiloženy k nahlédnutí v \ref{fig:Pripravek}.
